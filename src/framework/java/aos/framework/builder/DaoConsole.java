...
public class DaoConsole {
	...
	public static void main(String[] args) throws SQLException {
		...
		driverOpt.setPassword("123456");
		//===================
		Dto dto = Dtos.newDto();
		//改为自己存放相关文件的磁盘文件路径
		dto.put("outPath", "E:\\workSpace\\osworks-AOS-v3.0-release\\AOS\\01.SRC-BACKEND\\src\\dao\\java\\aos\\framework\\dao");
		//改为自己相关文件的包路径
		//dto.put("package", "aos.system.dao");
		//dto.put("package", "aos.system.dao");
		dto.put("package", "aos.framework.dao");
		dto.put("author", "zhang");
		//指定多张表请用逗号分隔；
		//!!表名区分大小写的喔
