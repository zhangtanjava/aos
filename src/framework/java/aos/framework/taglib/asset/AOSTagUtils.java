package aos.framework.taglib.asset;
...
public class AOSTagUtils {
	...
	public static String getMyUrl(String url) {
		if (AOSUtils.isNotEmpty(url) && StringUtils.indexOf(url, "do.jhtml") == -1) {
			url = "do.jhtml?router=" + url; 
		}
		return url;
	}
	 ...
	 * @return
	 */
	public static String getCurSkin(HttpServletRequest request) {
		String skin_ = null;
